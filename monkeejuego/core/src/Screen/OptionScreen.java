...
public class OptionScreen implements Screen {
    ...
    public void show() {
        ...
        botnAudioInterfaz.setPosition((stage.getWidth() - botnAudioInterfaz.getWidth()) / 2 - 100, 500);
        ...
        botnDer.setPosition((stage.getWidth() - botnAudioInterfaz.getWidth()) / 2 + 100, 500);
